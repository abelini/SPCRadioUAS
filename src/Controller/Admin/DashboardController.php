...
use App\Model\Entity\TipoSolicitud;
    ...
    public function index() : Response {
		...
		switch($this->user->permisos[0]->name) {
			case Permiso::ADMINISTRATOR 	: 	$this->solicitudes = $this->getSolicitudesStats();
											...
											break;
			case Permiso::CAPTURISTA 		: 	$this->solicitudes = $this->getSolicitudesStats();
											$this->bitacoras = $this->getBitacorasStats();
											$this->programas = $this->getProgramasStats();
											break;
											
			case Permiso::FONOTECARIO		:	$this->solicitudes = $this->getSolicitudesStats();
											$this->bitacoras = $this->getBitacorasStats();
											$this->programas = $this->getProgramasStats();
											break;							
			default						:
