<div class="content">
	...
	<table class="w3-table-all">
		<tr>
			<th>Bitacora</th>
			<td>#<?= $reporte->bitacoraID ?> | <?= $reporte->bitacora->fecha->i18nFormat(\IntlDateFormatter::FULL) ?>
			</td>
		</tr>
		<tr>
			<th>Operador</th>
				...
				<?php foreach ($reporte->reportes_programas as $rp): ?>
					<tr>
						...
						<td class="actions">
							...
							<?= $this->Form->deleteLink('<i class="fa-regular fa-trash-can"></i>', ['controller' => 'ReportesProgramas', 'action' => 'delete', $rp->ID], ['confirm' => __('Are you sure you want to delete # {0}?', $rp->ID), 'escape' => false]) ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</table>
