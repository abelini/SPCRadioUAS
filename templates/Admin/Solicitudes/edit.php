<div class="solicitudes form content">
	...
	<?= $this->Form->create($solicitud, ['type' => 'PUT']) ?>
		...
		<?= $this->Form->select('tipoSolicitudID', $tipos, ['class' => 'w3-select']); ?>
		...
		<?= $this->Form->select('productorID', $productorTecnico, ['class' => 'w3-select', 'empty' => false])?>
...
<script type="text/javascript">
	...
	jQuery('#fecha').datetimepicker({format:'Y-m-d H:i', lang:'es', minDate:0, step:30,
			value:'<?= $solicitud->fecha->format('Y-m-d h:i:s') ?>',
			i18n:{
				es:{
