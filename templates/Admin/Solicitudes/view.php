...
<?php if($solicitud->cancelado) : ?>
	<span class="w3-tag w3-xlarge w3-padding w3-red w3-right"><i class="fa-solid fa-box-archive"></i> DOCUMENTO CANCELADO</span>
<?php endif; ?>
	...
	<?= $this->Form->postLink('<i class="fa-regular fa-trash-can"></i> Eliminar esta solicitud', ['action' => 'delete', $solicitud->ID], ['method' => 'DELETE', 'confirm' => 'Esto eliminará permanentemente esta solicitud', 'class' => 'w3-button w3-red w3-right', 'escape' => false])?>
