...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->deleteLink(__('Delete Asignacione'), ['action' => 'delete', $asignacione->ID], ['confirm' => __('Are you sure you want to delete # {0}?', $asignacione->ID), 'class' => 'side-nav-item']) ?>
