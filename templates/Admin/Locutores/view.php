...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->deleteLink(__('Delete Locutor'), ['action' => 'delete', $locutore->ID], ['confirm' => __('Are you sure you want to delete # {0}?', $locutore->ID), 'class' => 'side-nav-item']) ?>
                            ...
                            <?php foreach ($locutore->permisos as $permiso): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <?= $this->Form->deleteLink(__('Delete'), ['controller' => 'Permisos', 'action' => 'delete', $permiso->ID], ['confirm' => __('Are you sure you want to delete # {0}?', $permiso->ID)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
