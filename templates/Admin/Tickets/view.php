        ...
        <div class="tickets view content">
            ...
            <table>
                <tr>
                    ...
                    <td><?= $ticket->hasValue('bitacora_vigilancium') ? $this->Html->link($ticket->bitacora_vigilancium->ID, ['controller' => 'BitacoraVigilancia', 'action' => 'view', $ticket->bitacora_vigilancium->ID]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Usuario') ?></th>
                    <td><?= $ticket->hasValue('usuario') ? $this->Html->link($ticket->usuario->name, ['controller' => 'Usuarios', 'action' => 'view', $ticket->usuario->ID]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('ID') ?></th>
