<div class="w3-section">
    ...
    <?= $this->Form->create() ?>
		...
		<?php if(isset($retrieveLink)) : ?>
			<p class="w3-medium w3-text-red w3-center" style="margin:0;"><?= $this->Html->link('Olvidé la contraseña', ['action' => 'retrieve'])?></p>
		<?php endif; ?>

    <?= $this->Form->button('Iniciar sesión', ['class' => 'w3-button w3-green w3-galaxy-blue']); ?>
    <?= $this->Form->end() ?>
</div>