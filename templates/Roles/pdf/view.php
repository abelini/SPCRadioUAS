<div class="asignaciones w3-responsive">
	...
	<div style="text-align:center;text-transform:uppercase;background-color:#0094CD !important;padding:1px;">
		<h2 style="font-size:20px;color:#fff;font-family:'Montserrat';"><?= $rol->fechaInicio->i18nFormat("EEEE d 'de' MMMM")?> a <?= $rol->fechaFin->i18nFormat("EEEE d 'de' MMMM 'de' YYYY")?></h2>
	</div>
	...
	<?php endforeach;?>
	<div class="w3-padding w3-center" style="background:#c49e0d;color:#fff;font-family:'Montserrat';text-transform:uppercase;">
