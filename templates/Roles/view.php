<div class="asignaciones w3-responsive">
	<div class="w3-galaxy-blue head w3-padding w3-center">
		<span class="w3-left w3-xxlarge">
			<?= $rol->previous() != null ? $this->Html->link('<i class="fa-solid fa-circle-chevron-left"></i>', ['?' => ['rol' => $rol->previous()->ID]], ['escape' => false]) : '' ?>
		</span>
		<span class="w3-right w3-xxlarge">
			<?= $rol->next() != null ? $this->Html->link('<i class="fa-solid fa-circle-chevron-right"></i>', ['?' => ['rol' => $rol->next()->ID]], ['escape' => false]) : '' ?>
		</span>
		<h1>ROL DE CABINA</h1>
	</div>
