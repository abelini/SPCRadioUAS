...
<div style="padding:0.01em 16px;color:#fff!important;background-color:#2A4B7C!important;">
	<h3>
		<?= $rol->fechaInicio->i18nFormat("d 'de' MMMM") ?> al
		<?= $rol->fechaFin->i18nFormat("d 'de' MMMM 'de' YYYY") ?>
	</h3>
</div>
...
<div style="padding:4px;width:100%;background-color:#877514;color:#fff;">
	<p style="text-align:center">Dirección de Radio UAS ©
		<?= $rol->fechaInicio->format("Y") ?>
	</p>
</div>
