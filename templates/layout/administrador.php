...
<body>
	...
	<main class="main">
		<nav class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" id="menu">
			...
			<?= $this->Html->link('<i class="fa-solid fa-chart-simple"></i> Uso de streaming', ['controller' => 'StreamHits', 'action' => 'index'], ['class' => 'w3-bar-item w3-button w3-border-bottom', 'escape' => false]) ?>
